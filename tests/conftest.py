...
def mock_api_v2_resource(mocker):
    ...
    mocker.patch.object(
        ...
        return_value=MockResponse(
            text="""{"API_version":"v2", "AFS_version":"2.1.1.dev0"}""", status_code=200
        ),
    )
...
def mock_api_v1_resource(mocker):
    ...
    mocker.patch.object(
        ...
        "get",
        return_value=MockResponse(
            text="""{"API_version":"v1", "AFS_version":"1.2.29"}""", status_code=200
        ),
    )
...
def mock_api_v2_AFS_API_VERSION_resource(mocker):
    ...
    mocker.patch.object(
        ...
        "get",
        return_value=MockResponse(
            text="""{"API_version":"v2", "AFS_version":"2.1.7"}""", status_code=200
        ),
    )
